...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Truvideo/truvideo-sdk-ios-camera.git", branch: "main") // Add 
    ],
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "TruvideoSdkCamera", package: "truvideo-sdk-ios-camera") // Add Truvideo SDK
            ],
